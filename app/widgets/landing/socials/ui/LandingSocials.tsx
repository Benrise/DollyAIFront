...
export function LandingSocials() {
    return (
        <section className="flex flex-col-reverse md:flex-row p-8 pb-0 xl:p-16 xl:pb-0 gap-12 border overflow-hidden border-border rounded-4xl justify-around items-center w-full bg-card">
            <div className="relative rounded-4xl border-border border-1 border-b-0 p-4 bg-white rounded-b-none overflow-hidden">
                <video
                    autoPlay
                    loop
                    muted
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex gap-4">
                    <Button size="icon" className='rounded-full' asChild>
                        <NextLink className='flex' href={"https://instagram.com/"} target="_blank" rel="noreferrer noopener">
                            <InstagramOutlined/>
                        </NextLink>
                    </Button>
                    <Button size="icon" className='rounded-full' asChild>
                        <NextLink className='flex' href={"https://twitter.com/"} target="_blank" rel="noreferrer noopener">
                            <TwitterOutlined/>
                        </NextLink>
                    </Button>
                    <Button size="icon" className='rounded-full' asChild>
                        <NextLink className='flex' href={"https://tiktok.com/"} target="_blank" rel="noreferrer noopener">
                            <TikTokOutlined/>
                        </NextLink>
                    </Button>
                    <Button size="icon" className='rounded-full' asChild>
                        <NextLink className='flex' href={"https://youtube.com/"} target="_blank" rel="noreferrer noopener">
                            <YoutubeOutlined/>
                        </NextLink>
                    </Button>
                    <Button size="icon" className='rounded-full' asChild>
                        <NextLink className='flex' href={"https://facebook.com/"} target="_blank" rel="noreferrer noopener">
                            <FacebookOutlined/>
                        </NextLink>
                    </Button>
                </div>
